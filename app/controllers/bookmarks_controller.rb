class BookmarksController < ApplicationController
  ...
  #before_action(:load_current_user) --> this will automatically call this method before any action is taken (do this instead of copying self.load_current_user repeatedly)
